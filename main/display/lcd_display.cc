...
SpiLcdDisplay::SpiLcdDisplay(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
    ...
    port_cfg.task_stack = 8192;  // Increased stack size to prevent overflow with compressed fonts
    ...
    ESP_LOGI(TAG, "SpiLcdDisplay: Applying theme: %s", current_theme_name_.c_str());
...
RgbLcdDisplay::RgbLcdDisplay(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
    ...
    ESP_LOGI(TAG, "RgbLcdDisplay: Applying theme: %s", current_theme_name_.c_str());
